...
import { Heart, Minus, Plus, ShoppingBag, Sparkles, Star } from 'lucide-react'
...
export default function ProductDetail() {
  ...
  const brandName = product.brand || 'Thương hiệu'
  const categoryName = product.category || 'Nước hoa'
  const volumeLabel = product.volume || '50ml'
  const genderLabel = product.gender || 'Unisex'
  const concentrationLabel = product.concentration || 'EDP'
      ...
      <div className="detail-content">
        <div className="detail-product-shell">
          <div className="detail-gallery-panel">
            ...
            <div className="detail-brand-label">{brandName}</div>
          </div>

          <section className="detail-info-card">
            <div className="detail-pill-row">
              <span className="detail-pill">{brandName}</span>
              <span className="detail-pill detail-pill--muted">{categoryName}</span>
            </div>
            ...
            <div className="detail-price-block">
              {originalPrice ? <span className="detail-old-price">{formatPrice(originalPrice)}</span> : null}
            ...
            <p className="detail-description">
              {product.description || 'Hương thơm được chọn theo từng sản phẩm thật từ kho hàng của cửa hàng.'}
            </p>
